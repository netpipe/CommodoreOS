...
cc65 -t c64 -O -o ramdisk3.s ramdisk3.c
#acme -v4 -f cbm -o ramdisk3.prg ramdisk3.asm ramdisk3.s
cat startup.asm ramdisk3.s > assembly.asm
ca65 -o ramdisk3.prg assembly.asm
#ca65 -o ramdisk-demo.prg assembly.asm
